...
<div id="page">
    ...
    <div class="nocss">
        ...
        <p>For more informations, see <a href="http://docs.jelix.org/en/manual-1.5/server-configuration"
    ...
    <div class="block">
        ...
        <div class="blockcontent">
            <ul>
                ...
                <li><a href="http://docs.jelix.org/en/manual-1.5">Read the documentation of Jelix</a></li>
